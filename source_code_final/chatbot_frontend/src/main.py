...
with st.sidebar:
    ...
    st.markdown(
        ...
        agent designed to answer questions about employees and things that will be useful for them.
        The agent uses  retrieval-augment generation (RAG) over both structured and unstructured data that 
        has been mocked.
        """
    )
    ...
    #How is the mood in the AWM department?
    #how is the mood across the firm?


st.title("Employee Chatbot")
st.info(
    """Ask me questions about employees, seat reservation, overall mood in the firm, etc.!"""
)
